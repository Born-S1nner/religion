...
class PeersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create peer" do
    assert_difference('Peer.count') do
      post peers_url, params: { peer: { email: @peer.email, religion: @peer.religion, username: @peer.username } }
    end
  ...
  test "should update peer" do
    patch peer_url(@peer), params: { peer: { email: @peer.email, religion: @peer.religion, username: @peer.username } }
